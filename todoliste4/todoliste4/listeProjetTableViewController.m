//
//  listeProjetTableViewController.m
//  todoliste4
//
...
#import "Taches.h"
#import "Projects.h"
@interface listeProjetTableViewController ()

@end

@implementation listeProjetTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *cellIdentifiant =@"Cell";
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifiant forIndexPath:indexPath];
    cell.textLabel.text =@"make projet";
    cell.detailTextLabel.text =@"test liste projet";
